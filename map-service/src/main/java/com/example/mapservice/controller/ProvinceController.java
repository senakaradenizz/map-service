...
public abstract class ProvinceController implements BaseController{
    ...
    public ResponseEntity<ProvinceEntity> findById(@PathVariable(value = "id") Long provinceId) throws ResourceNotFoundException{
